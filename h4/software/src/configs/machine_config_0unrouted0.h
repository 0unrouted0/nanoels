...
#ifndef MACHINE_CONFIG_SETTINGS_H
#define MACHINE_CONFIG_SETTINGS_H
...
const long MAX_TRAVEL_MM_Z = 500; // Lathe bed doesn't allow to travel more than this in one go, 30cm / ~1 foot
const long BACKLASH_DU_Z = 4950; // 0.65mm backlash in deci-microns (10^-7 of a meter)
...
const long SCREW_X_DU = 20000; // 1.25mm lead screw with 3x reduction in deci-microns (10^-7) of a meter
...
const long MAX_TRAVEL_MM_X = 250; // Cross slide doesn't allow to travel more than this in one go, 10cm
const long BACKLASH_DU_X = 2550; // 0.15mm backlash in deci-microns (10^-7 of a meter)
